...
const PERMUTATION_COUNTS: [usize; 4] = [1, 10, 100, 1000];

fn bench_poseidon2BatchPermutation(c: &mut Criterion) {
...
criterion_group!(benches, bench_poseidon2BatchPermutation);
